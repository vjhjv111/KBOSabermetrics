...
const props={batterId:'RF',pitcherId:'P',view:{roster:{revision:'test'}},seasonGame:{half:'top',homeTeam:'LG',awayTeam:'HH',homeLineup:positions,awayLineup:unknown,playerStats:{}},appearances:{C:{bodyType:'lean',heightCm:160,jerseyNumber:'42',skinTone:'#654321',gloveColor:'#abcdef'}}};
refresh(props,1,1);
...
assert.equal(catcher.sign,-1);assert.equal(catcher.root.scale.x,-.9*210/185);assert.equal(catcher.root.scale.y,.9*210/185);
